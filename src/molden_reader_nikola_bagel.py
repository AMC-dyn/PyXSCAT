...
def _read_MO(file, mo_cutoff):
    ...
    nMO = len(mo_this)
    idx = np.arange(nMO) # this used to be for MOLPRO but is being changed for bagel, I want to murder whomever wrote this.
    ...
    return (np.transpose(mo), occ_array, energy_array, idx)
