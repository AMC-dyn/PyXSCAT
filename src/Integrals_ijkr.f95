...
module integrals_ijkr
  ...
  END DO
    ...
    subroutine variables_total(px,py,pz,ddx,ddy,ddz,z1,z2,e12,p0matrix &
        ...
        real(kind=dp), intent(out), dimension(nq,maxl*4,maxl*4,maxl*4) :: p0matrix
